...
>
    Changelog
          ...
          <NavLink to="/docs/v0.3#install" className="premium-nav-link">
            Install
          </NavLink>

          <NavLink to="/docs/v0.3#api" className="premium-nav-link api-link">
            API
          </NavLink>
    ...
    Datasets
        ...
        <div className="header-right">
          <div className="version-switcher">
            <button
              type="button"
              className={`version-switcher-button ${versionOpen ? "open" : ""}`}
                ...
                {versions.map((version) => (
                  ...
                  >
                    <span className="version-option-main">
                      ...
                      {version.latest && <small>Latest</small>}
                    </span>

                    {version.latest && <span className="version-check">✓</span>}
                  </Link>
                ))}
              </div>
            )}
        ...
        <div className="mobile-menu-inner">
          ...
          <nav>
            ...
            <NavLink
              ...
              className="mobile-link"
            >
              <span className="mobile-index">03</span>
